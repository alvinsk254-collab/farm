...
export const products: Product[] = [
  // HERBICIDES
  {
    ...
    category: "herbicides",
    description:
      "Non-selective, post-emergence herbicide for control of all grasses and broad-leaved weeds.",
    price: "",
    rating: 4.8,
  ...
  // INSECTICIDES
  {
    ...
    description:
      "Insecticide for control of aphids, thrips, whiteflies and caterpillars.",
    price: "",
    rating: 4.9,
    ...
    modeOfAction:
      "Systemic insecticide with translaminar activity, contact and stomach action.",
    inStock: true,
  ...
  },
  {
    ...
    category: "insecticides",
    description:
      "Fast-acting, broad-spectrum carbamate insecticide used to control a wide range of pests.",
    price: "",
    rating: 4.6,
    features: [
      "Fast-acting",
    ...
    packSizes: ["100 gms"],
    modeOfAction:
      "Inhibits cholinesterase activity in insects, leading to rapid paralysis and death upon contact or ingestion.",
    inStock: true,
  ...
  },
  {
    ...
    category: "insecticides",
    description:
      "Insecticide for the control of thrips, aphids and white flies.",
    price: "",
    rating: 4.8,
    features: [
      "Nervous system destroyer",
    ...
    modeOfAction:
      "Destroys insects' nervous system by antagonising Acetylcholine receptor.",
    inStock: true,
  ...
  },
  {
    ...
    category: "insecticides",
    description:
      "Broad-spectrum insecticide for control of multiple pest types.",
    price: "",
    rating: 4.7,
    features: [
      "Broad-spectrum",
    ...
    modeOfAction:
      "Disrupts neuronal function in insects through sodium channel interference.",
    inStock: true,
  ...
  // FUNGICIDES
  {
    ...
    packSizes: ["50 mls", "100 mls", "250 mls", "500 mls", "1Ltr"],
    modeOfAction:
      "Disrupts normal fungal cell functions and inhibits spore germination and mycelia growth.",
    inStock: true,
  ...
  },
  {
    ...
    modeOfAction:
      "Protective contact fungicide that inhibits fungal spore germination.",
    inStock: true,
  ...
  },
  {
    ...
    category: "fungicides",
    description:
      "Systemic, broad-spectrum fungicide for control of powdery mildew, rust, and scab.",
    price: "",
    rating: 4.7,
    features: [
      "Systemic",
    ...
    packSizes: ["50 mls", "100 mls", "250 mls", "500 mls", "1Ltr"],
    modeOfAction:
      "Inhibits ergosterol biosynthesis, disrupting fungal cell membranes and halting pathogen growth.",
    inStock: true,
  ...
  },
  {
    ...
    category: "fungicides",
    description:
      "Broad systemic fungicide with protective and curative action for comprehensive disease management.",
    price: "",
    rating: 4.6,
    features: [
      "Broad systemic",
    ...
    packSizes: ["50 mls", "100 mls", "250 mls", "500 mls", "1Ltr"],
    modeOfAction:
      "Antifungal with antimitotic and antineoplastic activities. Suppresses microtubule assembly resulting in apoptosis.",
    inStock: true,
  ...
  },
  {
    ...
    category: "fungicides",
    description:
      "A contact fungicide effective against a wide range of fungal diseases.",
    price: "",
    rating: 4.5,
    features: [
      "Contact fungicide",
    ...
    modeOfAction:
      "Forms a protective barrier on plant surfaces, preventing spore germination and disease spread.",
    inStock: true,
  ...
  // FOLIAR FERTILIZERS - LIQUID
  {
    ...
    description:
      "A high potassium and magnesium foliar fertilizer suitable for flower formation, prevention of flower and fruit abortion, fruit enlargement and sweetening.",
    price: "",
    rating: 4.7,
    features: [
      "High potassium",
  ...
  },
  {
    ...
    category: "fertilizers",
    description:
      "Contains high phosphorous essential for root formation, tuber development and overall plant metabolism. Adequate phosphorus enhances early root growth, improves flowering and fruiting, and increases crop resilience to environmental stress.",
    price: "",
    rating: 4.6,
    features: [
      "High phosphorous",
    ...
    targetCrops: [
      "All crops in the early growth stages and tuber crops at the onset of tuber development",
    ],
    usage: "20 – 30 ml/20 L of water",
    applicationRate: "20 – 30 ml/20 L of water",
    packSizes: [
  ...
  },
  {
    ...
    category: "fertilizers",
    description:
      "Improves photosynthesis and boosts resistance to environmental stress directly influencing plant vigor, leaf development, and grain formation. Foliar application enhances nutrient efficiency, leading to better yields, improved crop quality, and stronger resilience against diseases and drought conditions.",
    price: "",
    rating: 4.7,
    features: [
  ...
  },
  {
    ...
    category: "fertilizers",
    description:
      "Liquid foliar fertilizer and plant booster. They offer quick nutrient absorption, especially during critical growth stages or when soil uptake is limited. This boosts crop yield, enhances quality, and improves resilience against pests and diseases.",
    price: "",
    rating: 4.8,
    features: [
      "Quick absorption",
      "Critical growth support",
      "Yield booster",
      "Quality enhancer",
      "Pest resilience",
    ],
  ...
  },
  {
    ...
    category: "fertilizers",
    description:
      "Zinc boosts enzyme activity and chlorophyll production, enhancing plant growth and leaf development. Boron supports flower formation, pollen viability, and fruit setting. Together, they improve crop yield, quality, and resistance to environmental stress.",
    price: "",
    rating: 4.6,
    features: [
      "Enzyme activity",
  ...
  },
  {
    ...
    category: "fertilizers",
    description:
      "A water-soluble fertilizer with high phosphorous levels essential for proper root development and fruit quality at early growth stages. Perfect for establishing strong plant foundations and promoting healthy seedling growth.",
    price: "",
    rating: 4.7,
    features: [
      "Water-soluble",
  ...
  },
  {
    ...
    category: "fertilizers",
    description:
      "A well-balanced water-soluble fertilizer supporting optimal growth at every stage. It helps maximize yields and improve the quality of produce by providing balanced nutrition for vegetative growth.",
    price: "",
    rating: 4.8,
    features: [
      "Water-soluble",
  ...
  },
  {
    ...
    category: "fertilizers",
    description:
      "A water-soluble fertilizer with well-balanced nutrients suitable for quick results during flowering and fruit setting stages. Promotes abundant flowering and successful fruit development with superior quality.",
    price: "",
    rating: 4.9,
    features: [
      "Water-soluble",
  ...
  },
  {
    ...
    category: "fertilizers",
    description:
      "Strengthen plant cell walls, improving structural integrity and resistance to diseases and environmental stress. Calcium also enhances root development and nutrient uptake, leading to healthier, more productive crops.",
    price: "",
    rating: 4.8,
    features: [
  ...
  },
  {
    ...
    category: "fertilizers",
    description:
      "Granulated Humic acid is a water-soluble soil amendment and acid reducer. Reduces nutrient lock up and loss through leaching and promotes proper fertilizer usage in plants, reducing fertilizer loss and improving soil health.",
    price: "",
    rating: 4.7,
    features: [
      "Humic acid",
  ...
  // VETERINARY PRODUCTS
  {
    ...
    category: "veterinary",
    description:
      "A high phosphorous dairy mineral supplement that increases milk production and fastens conception. It also replenishes mineral reserves during the in-calf stage and enhances vigorous and healthy growth in cows and calves.",
    price: "",
    rating: 4.8,
    features: [
      "High phosphorous",
    ...
    composition:
      "NaCl - 23%, P – 11%, Zn - 5090 ppm, Mg - 4%, Ca – 20%, Mn – 4000 ppm, Cu – 1510 ppm, Co – 81 ppm, I – 322 ppm, Sn – 26 ppm, F – 0.001%",
  ...
  },
  {
    ...
    category: "veterinary",
    description:
      "A dietary supplement that aids in bone and teeth development and increases milk production. It also helps in the treatment of calcium and phosphorous deficiencies in all livestock, ensuring optimal skeletal health and productivity.",
    price: "",
    rating: 4.6,
    features: [
      "Bone development",
    ...
    usage:
      "Poultry: 250g per 70 Kg of feed. Other animals: 100 g per 70 Kg of feeds.",
    applicationRate:
      "Poultry: 250g per 70 Kg of feed. Other animals: 100 g per 70 Kg of feeds.",
    ...
    benefits: [
      ...
      "Increased milk production",
      "Deficiency correction",
      "Universal livestock supplement",
    ],
    inStock: true,
  ...
  },
  {
    ...
    category: "veterinary",
    description:
      "A mineral supplement for livestock that supports healthy growth and development across various animal species. Provides essential minerals for bone strength, immunity, and overall animal wellness.",
    price: "",
    rating: 4.7,
    features: [
      "Mineral supplement",
  ...
  return products.filter(
    (product) =>
      ...
      (product.modeOfAction &&
        product.modeOfAction.toLowerCase().includes(searchTerm.toLowerCase())),
  );
};
