      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-base sm:text-lg xl:text-xl text-gray-600 max-w-3xl mx-auto">
            Explore our comprehensive range of agricultural solutions. From crop
            protection to plant nutrition, we distribute only the highest
            quality products for farming success.
          </p>
        </motion.div>
              ...
              >
                ...
                <div
                  ...
                  style={{
                    perspective: "1500px",
                    boxShadow:
                      "inset 0 10px 40px rgba(0,0,0,0.1), inset 0 -10px 40px rgba(255,255,255,0.5)",
                  }}
                >
                  <img
                    src={getProductImage(
        ...
        >
          <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8 max-w-3xl mx-auto agriculture-shadow relative overflow-hidden">
            ...
            <p className="text-gray-600 mb-6 text-lg">
              Browse our complete product catalogue with detailed specifications
